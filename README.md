...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/dedupflow/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-dedupflow.git
cd tp-dedupflow
```
...
```bash
kubectl port-forward deployment/tp-dedupflow 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── dedup_workflow.json     # Main configuration file
```
...
---
*Generated by [DedupFlow Studio](https://pradeeptalari14.github.io/portfolio/tools/dedupflow/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
